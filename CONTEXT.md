...
`dev.inboxbridge.service.auth`. Tests that wire those moved auth services
outside CDI should use explicit setters or imports rather than package-private
field reach-throughs.
