...
That browser-extension sessions list is intentionally current-focused: active extension sessions remain visible, but revoked sessions disappear from the normal Security panel after 30 days so long-lived installations do not leave dozens of obsolete revoked rows in day-to-day account review.
