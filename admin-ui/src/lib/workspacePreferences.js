...
export const DEFAULT_UI_PREFERENCES = {
  ...
  authSecurityCollapsed: true,
  secretManagementCollapsed: true,
  ...
  adminSectionOrder: ['adminQuickSetup', 'systemDashboard', 'oauthApps', 'userManagement', 'authSecurity', 'secretManagement', 'globalStats'],
  language: 'en',
  themeMode: 'SYSTEM',
  dateFormat: 'AUTO',
  timezoneMode: 'AUTO',
