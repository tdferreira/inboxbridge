...
/**
 * Builds the ordered workspace section descriptors for the main and admin
 * dashboards so layout preferences can reorder sections without hard-coding
 * render trees directly inside `App`.
 */
    ...
    },
    {
      ...
      render: () => (
        <SecretManagementSection
          ...
          recoveryReviewLoading={isPending('secretManagementRecoveryReview')}
          retirementReviewLoading={isPending('secretManagementRetirementReview')}
