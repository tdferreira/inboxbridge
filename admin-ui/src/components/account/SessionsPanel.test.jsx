...
describe('SessionsPanel', () => {
  it('renders active and recent sessions and exposes revoke actions', () => {
    ...
    render(
      <SessionsPanel
        activeSessions={[
          { id: 1, current: true, ipAddress: '203.0.113.10', locationLabel: null, loginMethod: 'PASSWORD', lastSeenAt: '2026-03-30T12:05:00Z', expiresAt: '2026-03-30T13:00:00Z' },
          { id: 2, current: false, ipAddress: '203.0.113.11', locationLabel: null, loginMethod: 'PASSKEY', lastSeenAt: '2026-03-30T11:05:00Z', expiresAt: '2026-03-30T13:00:00Z' }
        ]}
        locale="en"
        onRevokeOtherSessions={onRevokeOtherSessions}
        onRevokeSession={onRevokeSession}
        recentLogins={[
          { id: 1, current: true, active: true, ipAddress: '203.0.113.10', locationLabel: null, loginMethod: 'PASSWORD', createdAt: '2026-03-30T12:00:00Z', lastSeenAt: '2026-03-30T12:05:00Z' }
        ]}
    ...
    expect(onRevokeSession).toHaveBeenCalledWith(2)
  })
})
