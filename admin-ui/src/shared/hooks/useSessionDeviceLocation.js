...
/**
 * Coordinates the optional browser-side device-location capture flow for the
 * current session, including prompt dismissal, permission tracking, automatic
 * retries after transient failures, and the explicit retry action.
 */
