...
/**
 * Tracks installability for the `/remote` PWA surface, combining browser
 * install-prompt events with lightweight manual-install heuristics for mobile
 * browsers that do not expose `beforeinstallprompt`.
 */
