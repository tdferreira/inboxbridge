...
- the Browser extensions card keeps active sessions and recently revoked extension sessions visible, but hides revoked entries once they are older than 30 days so the security panel does not fill up with stale history
