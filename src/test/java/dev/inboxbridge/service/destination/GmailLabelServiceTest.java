...
class GmailLabelServiceTest {
    ...
    @Test
    void resolveLabelIdsForSystemTargetFailsClearlyWhenEnvRefreshTokenIsBlockedByPolicy() {
        GmailLabelService service = new GmailLabelService();
        service.googleOAuthService = new FakeGoogleOAuthService("stale-token");
        service.objectMapper = new ObjectMapper();
        service.userGmailConfigService = new FakeUserGmailConfigService();
        ...
        IllegalStateException error = assertThrows(IllegalStateException.class, () -> service.resolveLabelIds(Optional.of("Imported/IMAP")));
