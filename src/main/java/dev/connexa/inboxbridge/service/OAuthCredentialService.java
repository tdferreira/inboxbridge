...
import dev.connexa.inboxbridge.persistence.OAuthCredential;
import dev.connexa.inboxbridge.persistence.OAuthCredentialRepository;
...
public class OAuthCredentialService {
    ...
    public Optional<StoredOAuthCredential> findGoogleCredential() {
        return findCredential(GOOGLE_PROVIDER, "gmail-destination");
    }
    ...
    public StoredOAuthCredential storeGoogleCredential(
            ...
            String scope,
            String tokenType) {
        return storeCredential(GOOGLE_PROVIDER, "gmail-destination", refreshToken, accessToken, accessExpiresAt, scope, tokenType);
    }
