...
function applyTranslations() {
  ...
  setManyText([
    ...
    ['.hero-card-grid details:nth-of-type(1) .mini-kicker', 'hero.sources.kicker'],
    ['.hero-card-grid details:nth-of-type(1) h2', 'hero.sources.title'],
    ['.hero-card-grid details:nth-of-type(1) p', 'hero.sources.body'],
    ['.hero-card-grid details:nth-of-type(2) .mini-kicker', 'hero.dest.kicker'],
    ['.hero-card-grid details:nth-of-type(2) h2', 'hero.dest.title'],
    ['.hero-card-grid details:nth-of-type(2) p', 'hero.dest.body'],
    ['.hero-card-grid details:nth-of-type(3) .mini-kicker', 'hero.realtime.kicker'],
    ['.hero-card-grid details:nth-of-type(3) h2', 'hero.realtime.title'],
    ['.hero-card-grid details:nth-of-type(3) p', 'hero.realtime.body'],
    ['.hero-card-grid details:nth-of-type(4) .mini-kicker', 'hero.control.kicker'],
    ['.hero-card-grid details:nth-of-type(4) h2', 'hero.control.title'],
    ['.hero-card-grid details:nth-of-type(4) p', 'hero.control.body'],
    ...
    ['#secret-management .section-header .eyebrow', 'security.eyebrow'],
    ['#secret-management .section-header h2', 'security.title'],
    ['#secret-management .section-header p', 'security.body'],
    ['#secret-management .feature-card:nth-of-type(1) .mini-kicker', 'security.local.kicker'],
    ['#secret-management .feature-card:nth-of-type(1) h3', 'security.local.title'],
    ['#secret-management .feature-card:nth-of-type(1) p', 'security.local.body'],
    ['#secret-management .feature-card:nth-of-type(2) .mini-kicker', 'security.transit.kicker'],
    ['#secret-management .feature-card:nth-of-type(2) h3', 'security.transit.title'],
    ['#secret-management .feature-card:nth-of-type(2) p', 'security.transit.body'],
    ['#secret-management .feature-card:nth-of-type(3) .mini-kicker', 'security.split.kicker'],
    ['#secret-management .feature-card:nth-of-type(3) h3', 'security.split.title'],
    ['#secret-management .feature-card:nth-of-type(3) p', 'security.split.body'],
    ['#secret-management .feature-card:nth-of-type(4) .mini-kicker', 'security.rotation.kicker'],
    ['#secret-management .feature-card:nth-of-type(4) h3', 'security.rotation.title'],
    ['#secret-management .feature-card:nth-of-type(4) p', 'security.rotation.body'],
