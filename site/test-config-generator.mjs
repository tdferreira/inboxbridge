...
assert.equal(translate('en', 'env.option.sourceSpamJunkStrategy.ignore'), 'Leave spam/junk alone')
assert.equal(translate('en', 'env.option.sourceSpamJunkStrategy.importNormal'), 'Import as normal mail')
assert.equal(translate('en', 'env.option.sourceSpamJunkStrategy.importAndRoute'), 'Import and route to spam/junk')
assert.notEqual(translate('fr', 'env.option.sourceSpamJunkStrategy.ignore'), translate('en', 'env.option.sourceSpamJunkStrategy.ignore'))
...
assert.match(siteHtml, /Stronger secret management/)
assert.match(siteHtml, /Choose the custody model that fits your deployment\./)
assert.match(siteHtml, /OpenBao Transit or Vault Transit/)
assert.match(siteHtml, /split-key mode/)
assert.match(siteHtml, /Guided migration and re-encryption/)
assert.match(siteHtml, /cooldown-gated approvals/)
assert.match(siteHtml, /data-collapsible-card/)
assert.match(siteHtml, /class="feature-card collapsible-card"/)
assert.match(siteHtml, /class="how-card collapsible-card"/)
assert.match(siteHtml, /class="arch-card arch-card-sources collapsible-card"/)
assert.match(siteHtml, /class="architecture-detail-card architecture-detail-card-surface collapsible-card"/)
...
assert.match(siteHtml, /<option value="IGNORE">Leave spam\/junk alone<\/option>/)
assert.match(siteHtml, /<option value="IMPORT_NORMAL">Import as normal mail<\/option>/)
assert.match(siteHtml, /<option value="IMPORT_AND_ROUTE">Import and route to spam\/junk<\/option>/)
...
assert.match(siteJs, /setSelectOptionText/)
assert.match(siteJs, /env\.option\.sourceSpamJunkStrategy\.importAndRoute/)
...
assert.match(siteCss, /\.collapsible-card summary::after/)
assert.match(siteCss, /\.collapsible-card\[open\] summary::after/)
